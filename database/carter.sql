...
DELIMITER $$
CREATE TRIGGER `createCategory` BEFORE INSERT ON `category_list` FOR EACH ROW SET NEW.date_created = NOW()
$$
DELIMITER ;
...
('New Order 14', '2022-11-29 15:29:26');
...
(14, 13, 1, 95, '2022-11-29 15:29:26');
...
(14, '202211-00010', 3, 4, 95, 'Ganga Hostel, MNIT Jaipur', 0, '2022-11-29 15:29:26', '2022-11-29 15:29:26');

--
-- Triggers `order_list`
--
DELIMITER $$
CREATE TRIGGER `newoorder` BEFORE INSERT ON `order_list` FOR EACH ROW SET NEW.date_created = NOW()
$$
DELIMITER ;
DELIMITER $$
